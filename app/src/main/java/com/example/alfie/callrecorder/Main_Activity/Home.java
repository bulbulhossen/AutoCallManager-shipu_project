package com.example.alfie.callrecorder.Main_Activity;
...
import com.example.alfie.callrecorder.Auto_Answer_activity.AutoAnswerPreferenceActivity;
...
public class Home extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        auto_rec.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent auto_Intent_Answer = new Intent(Home.this,AutoAnswerPreferenceActivity.class);
                startActivity(auto_Intent_Answer);
            }
        });
